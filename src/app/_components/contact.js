...
export default function Contact() {
  return (
    ...
    >
      <Box w={["full", "full", "full", "50%"]} h={"560px"}>
        <Text fontWeight={600} fontSize={["40px", "40px", "64px", "64px"]}>
          Leave a message
        </Text>
        <Text
          width={"50rem"}
        ...
        >
          If you have questions to ask or suggestions to make , reach out to us{" "}
        </Text>
      ...
      <Box w={["full", "full", "full", "50%"]} h={"auto"}>
