...
export default function UserTopBar() {
  return (
    <Box w={"full"} h={"5rem"} display={"flex"} alignItems={"center"}>
      <Box
        w={["100%", "100%", "400", "400"]}
        display={"flex"}
        gap={"24px"}
      ...
      >
        ...
        >
          ...
          >
            <path
              d="M1.99902 12.001C1.99902 8.22998 1.99902 6.34398 3.17102 5.17298C4.34302 4.00198 6.22802 4.00098 9.99902 4.00098H13.999C17.77 4.00098 19.656 4.00098 20.827 5.17298C21.998 6.34498 21.999 8.22998 21.999 12.001C21.999 15.772 21.999 17.658 20.827 18.829C19.655 20 17.77 20.001 13.999 20.001H9.99902C6.22802 20.001 4.34202 20.001 3.17102 18.829C2.00002 17.657 1.99902 15.772 1.99902 12.001Z"
              stroke="#111111"
              stroke-width="1.5"
            />
            <path
              d="M9.99902 16.001H5.99902M13.999 16.001H12.499M1.99902 10.001H21.999"
              stroke="#111111"
              stroke-width="1.5"
        ...
        <Popover display={["block", "block", "none", "none"]}>
          <PopoverTrigger display={["block", "block", "none", "none"]}>
            <Button display={["block", "block", "none", "none"]}>
