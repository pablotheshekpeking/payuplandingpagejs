...
export default function SignUp() {
  ...
  const handleBack = () => {
    setStep((prevStep) => (prevStep > 1 ? prevStep - 1 : 1)); // Go back to the previous step
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        {step === 2 && (
          <>
            <Box display={'flex'} flexDirection={'column'} gap={'12px'} bg={'#FFF239'} border={'2px solid #111317'} borderRadius={'30px'} p={'20px'} justifyContent={'center'} alignItems={'center'}>
              ...
              <Checkbox defaultChecked fontSize={'16px'}>I agree to Pay Up’s <span style={{ fontWeight: 700, textDecoration: 'underline' }}>Terms and Conditions</span> and <span style={{ fontWeight: 700, textDecoration: 'underline' }}>Privacy Policy</span>.</Checkbox>

              <Button w={'100%'} h={'58px'} mt="24px" bg="black" onClick={handleNextStep} color={'#FFF239'} borderRadius={'20px'}>Continue</Button>
            </Box>
        ...
        {step === 3 && (
          <>
            ...
            <Button mt="24px" colorScheme="teal" onClick={handleNextStep}>Next Step</Button>
          </>
        )}

        {step === 4 && (
          <>
            <Text fontWeight={600} fontSize={'24px'} pb={'16px'}>Step 4: Review and Submit</Text>
            <Text fontSize={'18px'}>Please review your information before submitting</Text>
            {/* Add your content for step 4 here */}
            <Button mt="24px" colorScheme="teal" onClick={() => alert('Form submitted!')}>Submit</Button>
          </>
        )}
      </Box>
      ...
      >
        <Box display={'flex'} justifyContent={'right'}>
          <Box w={'400px'} px={'24px'} py={'12px'} bg={'#16160E6B'} display={'flex'} alignItems={'center'} borderRadius={'20px'}>
            ...
            <Box bg={'white'} w={'45%'} py={18} borderRadius={'14px'} cursor={'pointer'}>
